...
local global_theme_map = {
  ...
  ["ethereal"] = function()
    add("bjarneo/ethereal.nvim")
    return "ethereal"
  end,
  ["flexoki-light"] = function()
    add("stevedylandev/flexoki-nvim")
    return "flexoki-light"
  end,
  ["hackerman"] = function()
    add("bjarneo/hackerman.nvim")
    return "hackerman"
  end,
  ["matteblack"] = function()
  ...
  ["vantablack"] = function()
    add("space-chalk/space-chalk.nvim")
    return "vantablack"
  end,
  ["white"] = function()
    add("pgdouyon/vim-yin-yang")
    return "white"
  end,
}
...
local function opencode()
  ...
  end, { desc = "Add diagnostics to prompt" })
  -- Fix tmux navigation
